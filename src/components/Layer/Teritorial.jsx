      ...
      {isOpen && (
        <div className=" py-2 px-6 text-xs bg-[#FFFFFF] rounded-md">
          <ul>
            ...
            <li>
              <Checkbox label="Armada Dua" type="checkbox" showCircle={true} circleColor="bg-orange" reference={checkboxRef} />
            </li>
            <li>
              <Checkbox label="Armada Tiga" type="checkbox" showCircle={true} circleColor="bg-blue-sky" reference={checkboxRef} />
            </li>
            <li>
              <Checkbox label="Lanal" type="checkbox" showCircle={true} circleColor="bg-green-tea" reference={checkboxRef} />
            </li>
          </ul>
        </div>
      )}

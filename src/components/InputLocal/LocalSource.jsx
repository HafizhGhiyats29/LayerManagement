...
function LocalSource({ options, selectFileTypeValue, onChangeSelectFileTypeValue, fileNameInput, onChangeFileNameInput, onChangeUploadedFile, uploadedFile }) {
  return (
    <div>
      ...
      <SelectFileType fileTypes={options} value={selectFileTypeValue} onChangeValue={onChangeSelectFileTypeValue} />

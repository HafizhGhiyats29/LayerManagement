  ...
  return (
    ...
    >
      {isActive.map((activeEl) => (
        <button className={`${activeEl.value && 'bg-white bg-opacity-40'} w-full flex justify-center items-center `} onClick={onClickSidebarHandler} key={activeEl.name} type="button">
